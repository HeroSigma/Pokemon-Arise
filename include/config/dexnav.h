...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x04C // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x04D // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x04E // Allow player to find hidden mons
